...
public class TestMicroServer {
    ...
    @Test
    @DisplayName("awohara: Valid distances request succeeds with 200 status")
    public void testValidDistancesRequest() throws IOException {

        String requestBodyJSON = new JSONObject()
            .put("requestType", "distances")
            .put("places", new ArrayList())
            .put("earthRadius", 4.5)
            .toString();
    ...
    @Test
    @DisplayName("awohara: An invalid request responds with 400 status")
    ...
    @Test
    @DisplayName("awohara: The distances endpoint does not respond with a 404 status, meaning that it is valid.)")
    public void testDistancesValidEndpoint() throws IOException {
        String requestBodyJSON = new JSONObject()
            .put("requestType", "distances")
            .toString();
        HttpResponse response = postRequest("/api/distances", requestBodyJSON);
    ...
    @Test
    @DisplayName("awohara: The 'find' endpoint does not respond with a 404 status, meaning that it is valid.)")
    public void testFindValidEndpoint() throws IOException {
        String requestBodyJSON = new JSONObject()
