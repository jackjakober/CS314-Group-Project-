...
import * as FindResponseSchema from '../../schemas/FindResponse.json';
import * as TourResponseSchema from '../../schemas/TourResponse.json';
import { LOG } from './constants';

const SCHEMAS = {
    config: configSchema,
    distances: DistanceResponseSchema,
    find: FindResponseSchema,
