...
import { FaHome, FaPlus, FaTrashAlt, FaFolderOpen, BsSpeedometer2, FaFolderPlus, FaStopCircle, FaMinusCircle, FaSave } from 'react-icons/fa';
...
function buildMenuButtons(props) {
	return [
		...
		new MenuButtonProps('add-place-button', props.toggleAddPlace, <FaPlus />, 'Add Places'),
		...
		//new MenuButtonProps('save-trip-button', props.toggleSaveTrip, <FaSave />, 'Save Trip'),
		new MenuButtonProps('shorter-trip-button', props.getShorterTrip, <FaMinusCircle />,'Shorter Trip'),
